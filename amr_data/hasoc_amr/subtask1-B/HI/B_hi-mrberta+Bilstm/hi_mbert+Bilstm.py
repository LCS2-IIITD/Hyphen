...
output_model = './models/mbert+bilstm_models+last.pth'
best_score = 0  # 初始化 最好的得分为0
batch_size = 32

train_path = '../../../Data/task1_data/subtask1-B/sub-B_process/hi/train.csv'
dev_path = '../../../Data/task1_data/subtask1-B/sub-B_process/hi/dev.csv'
...
if __name__ == '__main__':
    ...
    ## 训练及验证
    train_eval(model, criterion, optimizer, train_loader, val_loader, epochs=15)  # 训练轮数
