...
classes2idx = {'NONE':0, 'HATE':1, 'OFFN':2, 'PRFN':3}
idx2classes = {0:'NONE', 1:'HATE', 2:'OFFN', 3:'PRFN'}

model_name = 'microsoft/deberta-base-mnli'
output_model = './models/deberta+bilstm_models+5e-5.pth'
best_score = 0  # 初始化 最好的得分为0
batch_size = 32

# train_path = '../../../Data/task1_data/subtask1-B/sub-B_process/en/train.csv'
# dev_path = '../../../Data/task1_data/subtask1-B/sub-B_process/en/dev.csv'
# # test_path='../Data/test.csv'
# test_path =  '../../../Data/task1_data/subtask1-B/sub-B_process/en/test.csv'
train_path = '/content/drive/MyDrive/hasoc2021/Data/task1_data/subtask1-B/sub-B_process/en/train.csv'
dev_path = '/content/drive/MyDrive/hasoc2021/Data/task1_data/subtask1-B/sub-B_process/en/dev.csv'
# test_path = '/content/drive/MyDrive/hasoc2021/Data/test/en_Hasoc2021_test_task1.csv'
test_path = '/content/drive/MyDrive/hasoc2021/Data/test/test_data_process/en_test.csv'

predict_class_id_path = './result/predict_class_id.csv'
result_path = './result/classify_result.csv'
...
class CustomDataset(Data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.with_labels:  # 如果数据集有标签，则为True
            label = self.data.loc[index, 'task_2']
...
def process_data(filename, classes2idx, with_labels=True):
    ...
    if with_labels:
        data = data.replace({'task_2': classes2idx})  # 如果 数据有标签 则将标签 转换为 数字
    return data
...
def test(model, dataloader, with_labels=False):
    ...
    with open(predict_class_id_path, encoding='utf-8') as f:
        ...
        # ids_test = df_test['_id'].tolist()  #清洗前的数据id
        ids_test = df_test['text_id'].tolist() #清洗后数据id
