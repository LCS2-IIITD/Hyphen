...
output_model = './models/squeezebert-models.pth'
...
predict_class_id_path = './result/squeezebert-predict_class_id.csv'
result_path = './result/squeezebert-classify_result.csv'
