...
model_name = 'rohanrajpal/bert-base-codemixed-uncased-sentiment'
output_model = './models/bert-base-model.pth'
...
test_path =  '../../../Data/task1_data/subtask1-A/sub-A_process/hi/test.csv'

predict_class_id_path = './result/bert-predict_class_id.csv'
result_path = './result/bert-classify_result.csv'
...
def train_eval(model, criterion, optimizer, train_loader, val_loader, epochs=1):
    ...
    for epoch in range(epochs):
        ...
        for i, batch in enumerate(tqdm(train_loader)):
            ...
            # global min_loss
            # if min_loss < val_loss:  # 如果当前得到的 模型精度更高 则保存模型
            #     min_loss = val_loss
...
def eval(model, optimizer, validation_dataloader):
    ...
    for batch in validation_dataloader:
        ...
        with torch.no_grad():
            ...
            # val_loss = criterion(logits, label_ids)
            # global min_loss
            # if min_loss < val_loss:  # 如果当前得到的 模型精度更高 则保存模型
            #     min_loss = val_loss
            #     save(models,optimizer)
...
if __name__ == '__main__':
    ...
    # optimizer = AdamW(models.parameters(), lr=5e-6)
