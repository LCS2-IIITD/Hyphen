...
model_name = "microsoft/mbert-base"
output_model = './models/mbert-models.pth'
...
predict_class_id_path = './result/mbert-predict_class_id.csv'
result_path = './result/mbert-classify_result.csv'
