...
output_model = './models/sqbert-models.pth'
best_score = 0  # 初始化 最好的得分为0
batch_size = 32

train_path = '../../../Data/task1_data/subtask1-A/sub-A_process/en/train1.csv'
dev_path = '../../../Data/task1_data/subtask1-A/sub-A_process/en/dev1.csv'
# test_path='../Data/test.csv'
test_path =  '../../../Data/task1_data/subtask1-A/sub-A_process/en/test.csv'

predict_class_id_path = './result/sqbert-predict_class_id.csv'
result_path = './result/sqbert-classify_result.csv'
