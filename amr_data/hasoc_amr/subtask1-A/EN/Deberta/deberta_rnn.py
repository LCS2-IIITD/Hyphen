...
output_model = './models/deberta+rnn_models.pth'
...
predict_class_id_path = './result/deberta+Rnn/predict_class_id.csv'
result_path = './result/deberta+Rnn/classify_result.csv'
...
class MyModel(nn.Module):
    ...
    def __init__(self, freeze_bert=False, model_name=model_name, hidden_size=768, num_classes=2):
        ...
        self.lstm = nn.RNN(hidden_size*4, hidden_size, 4 ,dropout=0.3)
