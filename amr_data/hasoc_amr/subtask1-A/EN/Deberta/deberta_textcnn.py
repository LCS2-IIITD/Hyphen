...
output_model = './models/deberta+textcnn_models.pth'
best_score = 0  # 初始化 最好的得分为0
batch_size = 32

train_path = '../../../Data/task1_data/subtask1-A/sub-A_process/en/train.csv'
dev_path = '../../../Data/task1_data/subtask1-A/sub-A_process/en/dev.csv'
# test_path='../Data/test.csv'
test_path =  '../../../Data/task1_data/subtask1-A/sub-A_process/en/test.csv'

predict_class_id_path = './result/deberta+textcnn/predict_class_id.csv'
result_path = './result/deberta+textcnn/classify_result.csv'
...
if __name__ == '__main__':
    ...
    # models.to(device)
    # optimizer = AdamW(models.parameters(), lr=1e-5, weight_decay=1e-2)
